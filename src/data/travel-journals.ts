...
export interface TravelStop {
  ...
  readonly overviewDot?: readonly [number, number];
}
export interface TravelMapCluster {
  readonly id: string;
  readonly name: string;
  readonly symbol: string;
  readonly anchor: readonly [number, number];
...
export const travelJournals: Record<JournalCountry, TravelJournal> = {
  ...
  china: { name: 'China', stops: chinaStops, photos: chinaPhotos, dates: '23 — 30 September', year: '2023', description: 'Places in Beijing, Hangzhou, and Shanghai, photographed between 23 and 30 September 2023.', countryView: '80 70 580 310', journeyView: '90 80 560 295' },
  india: { name: 'India', stops: indiaStops, photos: indiaPhotos, dates: 'September — October', year: '2023', description: 'The Taj Mahal and Agra Fort photographed on 17 September, and Rajgad Fort in Maharashtra on 28 October 2023.', countryView: '0 0 360 360', journeyView: '0 0 360 360' },
};
