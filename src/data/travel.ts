...
export const travelCountries: TravelCountry[] = [
  {
    ...
    caption: 'The rose-red city', places: 'Amman · Petra · Wadi Rum · Aqaba · Dead Sea',
  ...
  },
  {
    ...
    caption: 'Across the centuries', places: 'Luxor · Cairo · Giza',
  ...
  },
  {
    ...
    caption: 'State by state', places: 'Taj Mahal · Agra Fort · Rajgad Fort',
    note: 'Marble domes, red sandstone, and hilltop walls.',
  ...
  },
  {
    ...
    caption: 'A little make-believe', places: 'Beijing · Hangzhou · Shanghai',
